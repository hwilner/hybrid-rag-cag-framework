...
def create_large_scale_dataset() -> Tuple[List[str], List[Dict]]:
    ...
    questions = [
        ...
        {'question': 'How do the preservation methods used for ancient manuscripts compare to modern data backup and archival systems?', 'answer': 'Both address information preservation across time - manuscripts through physical protection, digital systems through redundant storage and format migration', 'type': 'preservation-methods', 'difficulty': 'very_hard', 'domain': 'history-technology'},
